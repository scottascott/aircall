...
const ActivityFeed =(props)=> {
    ...
    return (
        <div className="activity">
            <Popconfirm
                title="Are you sure to archive all calls?"
                onConfirm={confirm}
                onCancel={cancel}
                okText="Yes"
                cancelText="No"
            >
                <div className="archive-button" >
                    <div className="avtivity-node-left">
                        <Comment
                            author={<div style={{fontWeight:'bold',color:'black',paddingTop:"8px"}}>Archive all calls</div>}
                            avatar={<img src="https://i.ibb.co/YB7pWvp/image.png" alt="archive" />}
                        />
                    </div>
                </div>
            </Popconfirm>
